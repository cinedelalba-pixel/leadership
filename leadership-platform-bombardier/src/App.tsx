...
          <div dangerouslySetInnerHTML={{ __html: ganttChartHTML }}></div>
        )}

        {/* Sección Roadmap */}
        {activeSection === 'roadmap' && (
          <div dangerouslySetInnerHTML={{ __html: roadmapHTML }}></div>
        )}
...
          <div dangerouslySetInnerHTML={{ __html: activeSection === 'cronograma' ? ganttChartHTML : roadmapHTML }}></div>
        )}
      </main>
